...
def generate(dataset, opt, pipeline, checkpoint, scene_name, json_dir, text_feature_dir, threshold=0.8, device="cuda"):    
...
if __name__ == "__main__":
    ...
    generate(dataset_args, opt_args, pipe_args, ckpt_path, scene_name, json_dir, text_feature_dir, threshold=args.mask_thresh)
